      ...
      .then((data) => {
        ...
        `,
            ...
            `,
                ...
                res.status(400).json({
                  error: "ERROR: This contribution has already been reviewed",
                });
              }
            })
          ...
          res.status(403).json({
            error: "Users may only accept contributions to their own stories.",
          });
        }
      })
      .catch((err) => console.log(err));
  ...
  router.post("/:contribution_id/upvote", (req, res) => {
    ...
    `,
      ...
      .then((data) => {
        if (data.rows[0]) {
          res.status(400).json({
            error: "Error: User has already upvoted this contribution!",
          });
        } else {
